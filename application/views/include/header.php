...
<html lang="en">
    <head>
        ...
        <!-- <title>Correct Count - By Erav Technology</title> -->
        ...
        <link href="<?php echo base_url() ?>assets/css/account_payment_settle.css" rel="stylesheet" />
        <!-- <link href="<?php // echo base_url() ?>assets/css/other_styles.css" rel="stylesheet" /> -->
