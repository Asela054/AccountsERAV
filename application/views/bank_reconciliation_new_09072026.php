...
$(document).ready(function(){
    ...
    function updateBalanceSummary(){
        ...
        var accClose  = (accOpen + STATE.cr_running) - STATE.dr_running;
    ...
    function loadFinancialYears(bankaccId, callback){
        ...
        $.ajax({
            ...
            $.each(data, function(i, y){
                $drp.append('<option value="' + y.id + '">' + y.label + '</option>');
            });
    ...
    $('#drp_rec_month').on('change', function(){
        ...
        // Selected year/month ලෙස transactions reload
        STATE.rec_main_id = ''; // new period = new rec
    ...
    $('#btnApprove').on('click', function(){
        ...
        var accClose  = (STATE.acc_open_bal + STATE.cr_running) - STATE.dr_running;
        var diff      = stmtClose - accClose;
