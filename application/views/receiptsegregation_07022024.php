                        ...
                        <form id="segregationform">
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <select name="customer" id="customer" class="form-control form-control-sm" style="width:100%;" required>
                                        ...
                                        <?php foreach($customerlist as $rowcustomerlist){ ?>
                                        <option value="<?php echo $rowcustomerlist->idtbl_customer ?>"><?php echo $rowcustomerlist->customer ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="col">
                            ...
                            <div class="row">
                                <div class="col-5">
                                    ...
                                    <select name="chartofdetailaccount" id="chartofdetailaccount" class="form-control form-control-sm" required>
                                        <option value="">Select</option>
                                    </select>
                                </div>
                                <div class="col-5">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="seperateamount" id="seperateamount" class="form-control form-control-sm input-integer" required>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-12 text-right">
...
<script>
    $(document).ready(function() {
        ...
        $('#customer').select2({dropdownParent: $('#modalsegregation')});
            ...
            "columns": [
                ...
                },                
                {
                    ...
                    "render": function(data, type, full) {
                        ...
                        if(full['poststatus']==0){
                            if(editcheck==1){
                                button+='<button class="btn btn-primary btn-sm btnEdit mr-1" id="'+full['idtbl_account_receivable_main']+'"><i class="fas fa-pen"></i></button>';
                            }
                            if(statuscheck==1){
                                if(full['status']==1){
                                    button+='<a href="<?php echo base_url() ?>Receiptsegregation/Receiptsegregationstatus/'+full['idtbl_account_receivable_main']+'/2" onclick="return deactive_confirm()" target="_self" class="btn btn-success btn-sm mr-1"><i class="fas fa-check"></i></a>';
                                }else{
                                    button+='<a href="<?php echo base_url() ?>Receiptsegregation/Receiptsegregationstatus/'+full['idtbl_account_receivable_main']+'/1" onclick="return active_confirm()" target="_self" class="btn btn-warning btn-sm mr-1"><i class="fas fa-times"></i></a>';
                                }
                            }
                            if(deletecheck==1){
                            button+='<a href="<?php echo base_url() ?>Receiptsegregation/Receiptsegregationstatus/'+full['idtbl_account_receivable_main']+'/3" onclick="return delete_confirm()" target="_self" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a>';
                            }
                        }
            ...
            if (r == true) {
                ...
                $.ajax({
                    ...
                    success: function(result) { //alert(result);
                        ...
                        $('#customer').val(obj.customer).trigger('change').prop('disabled', true); 
        ...
        $('#btnaddtolist').click(function(){
            if (!$("#segregationform")[0].checkValidity()) {
                ...
                $('#tablesegregate> tbody:last').append('<tr><td class="d-none">' + chartdetailaccountID + '</td><td>' + chartdetailaccount + '</td><td>' + narration + '</td><td class="segamount text-right">' + segregationamount + '</td><td class="text-right"><button type="button" class="btn btn-danger btn-sm btnremoverow"><i class="fas fa-times"></i></button></td></tr>');
        ...
        $('#tablesegregate tbody').on('click', '.btnremoverow', function () {
    		var r = confirm("Are you sure, You want to remove this segregation? ");
    		if (r == true) {
