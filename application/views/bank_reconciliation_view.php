...
<div id="layoutSidenav">
	...
	<div id="layoutSidenav_content">
		<main>
				...
				<div class="container-fluid">
					<div class="page-header-content py-3">
						<h1 class="page-header-title font-weight-light">
							...
							<button type="button" class="btn btn-outline-primary btn-sm fa-pull-right dropdown-toggle"
								id="btnorderacts" style="position:absolute; right:10px;" data-toggle="dropdown"
								aria-haspopup="true" aria-expanded="false"><i
									class="fas fa-plus"></i>&nbsp;Actions</button>
							<div class="dropdown-menu" aria-labelledby="btnorderacts">
								<a class="dropdown-item" id="btnOngoingRecs" data-toggle="modal"
									data-target="#bankAccListModal" data-refid="-1" href="javascript:void(0);"
									title="Ongoing bank reconciliation">Ongoing Bank Recs.</a>
								<a class="dropdown-item" id="btnConfirmedRecs" data-toggle="modal"
									data-target="#bankRecListModal" href="javascript:void(0);"
									title="Search confirmed bank reconciliations">Completed Recs.</a>
						...
						<div class="card-body p-0 p-2">
							<div class="">
								<div class="form-group row">
									...
									<div class="col-md-6">
										<select class="form-control form-control-sm" id="drp_bank_accounts"
											disabled="disabled">
											<option value="-1">Select</option>
											<?php 
											foreach($company_bank_account_list as $qf){
											?>
											<option class="" value="<?php echo $qf->idtbl_account; ?>">
												<?php echo $qf->accountname; ?></option>
											<?php 	
											}
											?>
										</select>
									...
									<div class="col-md-3">
										<input type="text" class="form-control form-control-sm" id="txt_bank_rec_period"
							...
							<div class="row">
								<div class="col-md-3">
									...
									<input type="text" class="form-control form-control-sm stmt_bal_input"
										id="txt_statement_open_bal" value="" required />
								</div>
								<div class="col-md-3">
									<label>CR.</label>
									<input type="text" class="form-control form-control-sm stmt_bal_input"
										id="txt_statement_tot_cr" value="" required />
								</div>
								<div class="col-md-3">
									<label>DR.</label>
									<input type="text" class="form-control form-control-sm stmt_bal_input"
										id="txt_statement_tot_dr" value="" required />
								</div>
								<div class="col-md-3">
									<label>Statement Closed Bal.</label>
									<input type="text" class="form-control form-control-sm stmt_bal_output"
										id="txt_statement_closed_bal" value="" readonly="readonly" />
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-3">
									...
									<input type="text" class="form-control form-control-sm" id="txt_account_open_bal"
										value="" readonly="readonly" />
								</div>
								<div class="col-md-3">
									<label>CR.</label>
									<input type="text" class="form-control form-control-sm" id="txt_account_tot_cr"
										value="" readonly="readonly" />
								</div>
								<div class="col-md-3">
									<label>DR.</label>
									<input type="text" class="form-control form-control-sm" id="txt_account_tot_dr"
										value="" readonly="readonly" />
								</div>
								<div class="col-md-3">
									<label>Account Closed Bal.</label>
									<input type="text" class="form-control form-control-sm" id="txt_account_closed_bal"
										value="" readonly="readonly" />
								</div>
							</div>
							...
							<div class="row" style="margin-top:10px;">
								<div class="col-md-3">
									...
									<fieldset>
										...
										<input type="date" class="form-control form-control-sm" id="txt_bank_rec_date"
											value="" />
									</fieldset>
								</div>
								<div class="col-md-9">
									<fieldset>
										...
										<div class="row">
											<div class="col-md-4">
												<input type="text" class="form-control form-control-sm" id="txt_diff_cr"
													value="" readonly="readonly" />
											</div>
											<div class="col-md-4">
												<input type="text" class="form-control form-control-sm" id="txt_diff_dr"
													value="" readonly="readonly" />
											</div>
											<div class="col-md-4">
												<input type="text" class="form-control form-control-sm"
													id="txt_diff_closed_bal" value="" readonly="readonly" />
											</div>
										</div>
									</fieldset>
								</div>
							...
							<div class="row" style="margin-top:15px;">
								...
								<div class="col-md-3">
									...
									<label for="drp_rec_value_dr" style="float:right;"
										title="Select for debit account"><input type="radio" name="drp_rec_value_group"
											id="drp_rec_value_dr" class="" value="" data-crkey="0" data-drkey="1"
											style="margin-right:3px; width:18px; height:18px; position:relative; top:3px;" />DR</label>
									<label for="drp_rec_value_cr" style="float:right; margin-right:15px;"
										title="Select for credit account"><input type="radio" name="drp_rec_value_group"
											id="drp_rec_value_cr" class="" value="" data-crkey="1" data-drkey="0"
											style="margin-right:3px; width:18px; height:18px; position:relative; top:3px;"
											checked="checked" />CR</label>
								...
								<div class="col-md-3">
									...
									<input type="text" id="txt_bank_narration" class="form-control form-control-sm"
										value="" />
								</div>
								<div class="col-md-3">
									<label for="">Value</label>
									<input type="text" id="txt_bank_amount" class="form-control form-control-sm"
										value="" />
								</div>
							</div>
						</div>
				...
				<div class="card rounded-0">
					<div class="card-body">
						<div class="table-responsive">
							<table class="table table-bordered table-sm" id="accDetail_dataTable" width="100%"
			...
			<div class="modal fade" id="bankAccListModal" tabindex="-1" role="dialog"
				aria-labelledby="bankAccListModalLabel" aria-hidden="true">
									...
									<div class="col-md-12">
										<div class="datatable table-responsive">
											<table class="table table-bordered table-hover dataTable no-footer"
												id="bankAccs_dataTable" width="100%" cellspacing="0">
												<thead>
													<tr>
			...
			<div class="modal fade" id="bankRecListModal" tabindex="-1" role="dialog"
				aria-labelledby="bankRecListModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-xl" role="document">
					<form id="" name="" method="post" action="">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="bankRecListModalLabel"><span>Choose an Account Rec.</span>
								</h5>
								<button class="close" type="button" data-dismiss="modal" aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button>
							...
							<div class="modal-body" style="min-height:350px;">
								<div class="row">
									...
									<div class="col-md-12">
										<div class="datatable table-responsive">
											<table class="table table-bordered table-hover dataTable no-footer"
												id="bankRecs_dataTable" width="100%" cellspacing="0">
												<thead>
													<tr>
														<th width="30%">Bank Account Name</th>
														<th>Code</th>
	...
	$(document).ready(function () {
		var bankAccsTable = $("#bankAccs_dataTable").DataTable({
			...
			"columnDefs": [{
				...
				render: function (data, type, row) {
					return '<button type="button" class="btn btn-sm btn-success btn_new_bankrec" data-mainid="" data-bankaccid="' +
						data +
						'"><i class="fa fa-edit"></i></button>'; //data+'x'+row.parent_company_regno;
				}
			}],
		...
		var bankRecsTable = $("#bankRecs_dataTable").DataTable({
			...
			"columns": [{
				...
				{
					"data": "bankrec_batchno",
					"width": '20%'
				}, //{"data":"parent_company_regno"}, 
				{
					"data": "bankrec_regno",
					"className": 'text-center',
					"width": '5%'
			...
			"columnDefs": [{
				"targets": 3,
				render: function (data, type, row) {
					return '<button type="button" class="btn btn-sm btn-success btn_edit_bankrec" data-mainid="' +
						data + '" data-bankaccid="' + row.bankacc_regno +
						'"><i class="fa fa-edit"></i></button>'; //data+'x'+row.parent_company_regno;
				}
			}],
		...
		$(document).on("click", ".btn_new_bankrec, .btn_edit_bankrec", function () {
			...
			$.ajax({
				...
				$("#txt_statement_open_bal").val(fnum(data.view_header_data.statement_open_bal,
				2));
				...
				$("#txt_statement_closed_bal").val(fnum(data.view_header_data.statement_closed_bal,
					2));
				...
				$("#h_rec_period_year").val(data.view_header_data
					.tbl_finacial_year_idtbl_finacial_year);
				$("#h_rec_period_month").val(data.view_header_data
		...
		$("#frmRecInfo").submit(function (event) {
			...
			$.ajax({
				...
				data: {
					bank_rec_date: bankRecDate,
					statement_open_bal: statementOpenBal,
					statement_tot_cr: statementTotCr,
					statement_tot_dr: statementTotDr,
					statement_closed_bal: statementClosedBal,
					rec_acc_id: recAccId,
					rec_period_year: recPeriodYear,
					rec_period_month: recPeriodMonth,
					rec_main_id: recMainId,
					main_account_id: mainAccountId,
					account_cr: accountCr,
					account_dr: accountDr,
					acc_period: accPeriod,
					main_account_narration: mainAccountNarration,
				...
				beforeSend: function () {
					$("#lbl_warnmsg").html(
						'<i class="fa fa-spinner fa-spin"></i>Updating. please wait');
				}
			}).done(function (data) {
				...
				if (rres != "") {
					...
					if (data.view_detail_data == '-1') {
						$('.chk_accd[data-revisestatus="1"]').each(function (index, value) {
							...
							var selected_tr = accDetailTable.row($(this).parent().closest(
								'tr'));
							var d = selected_tr.data();
			...
			*/
			...
			$.ajax({
				...
				if (data.toggle_status == 'success') {
					...
					var rec_detail_cr_val = (d.cr_val > 0) ? (parseFloat(d.cr_val) * (
						CHK_REC_INFO_STATUS + (CHK_REC_INFO_STATUS - 1))) : 0;
					var rec_detail_dr_val = (d.dr_val > 0) ? (parseFloat(d.dr_val) * (
						CHK_REC_INFO_STATUS + (CHK_REC_INFO_STATUS - 1))) : 0;
			...
			if (selected_tr.length > 0) {
				...
				if (del_res) {
					...
					$.ajax({
						...
						beforeSend: function () {
							$("#lbl_warnmsg").html(
								'<i class="fas fa fa-spinner fa-spin"></i>&nbsp;Please wait...'
								).fadeIn();
						}
					}).done(function (data) {
				...
				if (opt_approve) {
					...
					$.ajax({
						...
						data: {
							...
							exp_rows: 0,
							statement_open_bal: statementOpenBal,
							statement_cr: statementCr,
							acc_cr: accCr,
							statement_dr: statementDr,
							acc_dr: accDr,
							rec_period_year: recPeriodYear,
							rec_period_month: recPeriodMonth,
							statement_close: statementClose,
							acc_close: accClose
						},
						dataType: "JSON",
						beforeSend: function () {
