							...
							<div class="row">
								...
								<div class="col-4">
									<div class="form-group mb-1">
										...
										<div class="form-check form-check-inline">
											<input type="radio" id="bstatusGovernment" name="bstatus" value="Government" class="form-check-input" required>
											<label for="bstatusGovernment" class="form-check-label">Government</label>
										</div>
									</div>
								</div>
								<div class="col-4">
...
<script>
	$(document).ready(function () {
		...
		$('#tblsuppliertype tbody').on('click', '.btnEdit', async function() {
        	...
        	if (r == true) {
				...
				$.ajax({
					...
					success: function (result) { //alert(result);
						...
						} else if (busstatus == "Government") {
							$('#bstatusGovernment').prop('checked', true);
						}
