        ...
        $('#btnchoosecominfo').click(function(){
            if (!$("#searchform")[0].checkValidity()) {
                ...
                $('#dataTable').DataTable({
                    ...
                    "serverSide": true,
                    ajax: {
                        url: "<?php echo base_url() ?>scripts/receivedchequelist.php",
                    ...
                    "columns": [
                        ...
                        },
                        {
                            ...
                            "data": null,
                            "render": function(data, type, full) {
                                if(full['depositstatus']==1 && full['chequereturn']==0){
                                    return '<i class="fas fa-check-double mr-2"></i> Deposited';
                                }
                                else if(full['chequereturn']==1){
                        ...
                        },
                        {
                            ...
                            "render": function(data, type, full) {
                                var button='';
                                if(full['chequereturn']==0 && full['depositstatus']==1){
                                    button+='<button type="button" class="btn btn-danger btn-sm mr-1 btnReturn" id="'+full['idtbl_receivable']+'"><i class="fas fa-undo-alt"></i></button>';
                                }
