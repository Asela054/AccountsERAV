...
<div class="col-12">
    <h6 class="title-style small font-weight-bold mt-2"><span><?php echo $_SESSION['company'] ?> - <?php echo $creditorname; ?> Statement <?php echo $report_duration; ?></span></h6>
    <table class="table table-striped table-bordered table-sm small" id="tablereport">
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo $rowdata->repaydate ?></td>
                <td><?php echo $rowdata->regrnno ?></td>
                <td><?php echo $rowdata->narration; if($rowdata->tratype=='D'){echo ' ('.$rowdata->chequeno.' - '.$rowdata->chedate.')';} ?></td>
...
<input type="hidden" id="reporttitle" value="<?php echo $creditorname; ?> Statement">
<input type="hidden" id="filetitle" value="<?php echo $creditorname; ?>_sheet_">
<input type="hidden" id="reporttype" value="6">