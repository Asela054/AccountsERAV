<?php
class Paymentcreateinfo extends CI_Model{
    public function Paymentcreateinsertupdate(){
        ...
        if($recordOption==1){
            ...
            $this->db->where('idtbl_expence_info', $recordID);
            ...
            $this->db->where('idtbl_expence_info', $recordID);
            $this->db->update('tbl_expence_info', $data);
    ...
    public function Paymentcreateedit(){
        ...
        $obj=new stdClass();
        $obj->id=$respond->row(0)->idtbl_expence_info;
        $obj->supplier=$respond->row(0)->tbl_supplier_idtbl_supplier;
        $obj->suppliername=$respond->row(0)->suppliername;
        $obj->grnno=$respond->row(0)->grnno;
        $obj->grndate=$respond->row(0)->grndate;
    ...
    //     $this->db->select("`tbl_expence_info`.*, `tbl_company`.`company`, `tbl_company`.`address1`, `tbl_company`.`address2`, `tbl_company`.`mobile`, `tbl_company`.`phone`, `tbl_company`.`email`, $tablename.$column2 AS suppliername, `tbl_supplier`.`telephone_no`, CONCAT(`address_line1`, ' ', `address_line2`, ' ', `city`) AS `address`, `tbl_supplier`.`email`");
    //     $this->db->from('tbl_expence_info');
    //     $this->db->join('tbl_company', 'tbl_company.idtbl_company=tbl_expence_info.tbl_company_idtbl_company', 'left');
    //     $this->db->join("$tablename", "$tablename.$column1 = tbl_expence_info.tbl_supplier_idtbl_supplier", 'left');
    //     $this->db->where('tbl_expence_info.idtbl_expence_info', $recordID);
