...
class Chartofaccountdetailinfo extends CI_Model{
    ...
    public function Getaccountspecialcategorydata(){
        ...
        $this->db->from('tbl_account_detail');
        $this->db->join('tbl_account_allocation', 'tbl_account_allocation.tbl_account_detail_idtbl_account_detail = tbl_account_detail.idtbl_account_detail', 'left');
        $this->db->join('tbl_product_category', 'tbl_account_detail.special_cate_sub = tbl_product_category.idtbl_product_category AND tbl_account_detail.special_cate_detail = 1', 'left');
        $this->db->join('tbl_group_category', 'tbl_account_detail.special_cate_sub = tbl_group_category.idtbl_group_category AND tbl_account_detail.special_cate_detail = 2', 'left');
        $this->db->select('CASE 
            WHEN tbl_account_detail.special_cate_detail = 1 THEN tbl_product_category.category
            WHEN tbl_account_detail.special_cate_detail = 2 THEN tbl_group_category.category
            ELSE NULL
