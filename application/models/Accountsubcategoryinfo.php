<?php
class Accountsubcategoryinfo extends CI_Model{
    public function Accountsubcategoryinsertupdate(){
        ...
        // $subaccountcatecode=$this->input->post('subaccountcatecode');
        ...
        if($recordOption==1){
            $data = array(
                // 'code'=> $subaccountcatecode, 
                'subcategory'=> $subaccountcategory, 
                'status'=> '1', 
            ...
            $this->db->insert('tbl_account_subcategory', $data);
