...
class Chartofaccountdetailinfo extends CI_Model{
    ...
    public function Getaccountspecialcategorydata(){
        ...
        $this->db->from('tbl_account_detail');
        $this->db->join('tbl_account_allocation', 'tbl_account_allocation.tbl_account_detail_idtbl_account_detail = tbl_account_detail.idtbl_account_detail', 'left');
        $this->db->join('tbl_material_main_category', 'tbl_account_detail.special_cate_sub = tbl_material_main_category.idtbl_material_main_category AND tbl_account_detail.special_cate_detail = 1', 'left');
        $this->db->join('tbl_material_category', 'tbl_account_detail.special_cate_sub = tbl_material_category.idtbl_material_category AND tbl_account_detail.special_cate_detail = 2', 'left');
        $this->db->select('CASE 
            WHEN tbl_account_detail.special_cate_detail = 1 THEN tbl_material_main_category.main_category
            WHEN tbl_account_detail.special_cate_detail = 2 THEN tbl_material_category.categoryname
            ELSE NULL
