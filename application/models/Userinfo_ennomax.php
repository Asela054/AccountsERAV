...
class Userinfo extends CI_Model{
    ...
    public function Useraccountinsertupdate(){
        ...
        $username=$this->input->post('username');
        if(!empty($this->input->post('password'))){$password=password_hash($this->input->post('password'), PASSWORD_DEFAULT);}
    ...
    public function Getpermissionlist(){
        ...
        $this->db->where('guard_name', 'web-account');
