...
// DB table to use
$table = 'tbl_account_transaction_manual_main';

// Table's primary key
$primaryKey = 'idtbl_account_transaction_manual_main';
...
// indexes
$columns = array(
	array( 'db' => '`u`.`idtbl_account_transaction_manual_main`', 'dt' => 'idtbl_account_transaction_manual_main', 'field' => 'idtbl_account_transaction_manual_main' ),
	...
	array( 'db' => '`u`.`transactiontype`', 'dt' => 'transactiontype', 'field' => 'transactiontype' ),
