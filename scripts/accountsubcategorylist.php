...
// DB table to use
$table = 'tbl_account_subcategory';

// Table's primary key
$primaryKey = 'idtbl_account_subcategory';
...
$joinQuery = "FROM `tbl_account_subcategory` AS `u` LEFT JOIN `tbl_account_category` AS `ua` ON (`ua`.`idtbl_account_category` = `u`.`tbl_account_category_idtbl_account_category`)";
