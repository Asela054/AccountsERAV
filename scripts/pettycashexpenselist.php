...
$columns = array(
	...
	array( 'db' => '`u`.`pettycashcode`', 'dt' => 'pettycashcode', 'field' => 'pettycashcode' ),
	array( 'db' => '`u`.`amount`', 'dt' => 'amount', 'field' => 'amount' ),
	array( 'db' => '`u`.`poststatus`', 'dt' => 'poststatus', 'field' => 'poststatus' ),
	array( 'db' => '`u`.`reimbursestatus`', 'dt' => 'reimbursestatus', 'field' => 'reimbursestatus' ),
