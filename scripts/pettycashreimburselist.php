...
// DB table to use
$table = 'tbl_pettycash_reimburse';

// Table's primary key
$primaryKey = 'idtbl_pettycash_reimburse';
...
// indexes
$columns = array(
	array( 'db' => '`u`.`idtbl_pettycash_reimburse`', 'dt' => 'idtbl_pettycash_reimburse', 'field' => 'idtbl_pettycash_reimburse' ),
	array( 'db' => '`u`.`date`', 'dt' => 'date', 'field' => 'date' ),
	array( 'db' => '`u`.`openbal`', 'dt' => 'openbal', 'field' => 'openbal' ),
	array( 'db' => '`u`.`reimursebal`', 'dt' => 'reimursebal', 'field' => 'reimursebal' ),
	array( 'db' => '`u`.`closebal`', 'dt' => 'closebal', 'field' => 'closebal' ),
	...
	array( 'db' => '`u`.`chequecreate`', 'dt' => 'chequecreate', 'field' => 'chequecreate' ),
	array( 'db' => '`u`.`printstatus`', 'dt' => 'printstatus', 'field' => 'printstatus' ),
	array( 'db' => '`u`.`printstatus`', 'dt' => 'printstatus', 'field' => 'printstatus' ),
